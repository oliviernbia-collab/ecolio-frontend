...
export default function ParentAttendance() {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    api.get(`/portal/parent/children/${selectedChild}/attendance`)
  ...
  return (
    <Box>
      ...
      {!selectedChild ? (
        <Alert severity="info">Sélectionnez un enfant pour voir ses présences.</Alert>
      ) : (
        <>
          <Card sx={{ mb: 3 }}>
            <CardContent>
                          ...
                          : data.map((a, i) => {
                            ...
                            return (
                              <TableRow key={i}>
                                ...
                                <TableCell className="hide-xs">
                                  <Typography fontSize="0.8rem" color="text.secondary">{a.justification || '—'}</Typography>
                                </TableCell>
                              </TableRow>
                            )
                          })}
